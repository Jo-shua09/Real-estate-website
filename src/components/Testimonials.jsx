...
const Testimonials = () => {
  return (
    <div className="container flex flex-col justify-center mx-auto py-4 pt-20 md:px-20 lg:px-32 w-full overflow-hidden" id="testimonials">
      ...
      <p className="text-gray-500 max-w-80 text-center mx-auto mb-8 normal-case">Real Stories from Those Who Found Home with Us</p>
      ...
      <div className="flex flex-wrap justify-center gap-8">
        {testimonialsData.map((testimonial, index) => (
          <div key={index} className="max-w-[340px] border shadow-lg rounded px-8 py-12 text-center">
            ...
            <div
              className="flex justify-center gap-1 textred500
             mb-4"
            >
            ...
            <p className="text-gray-600 normal-case">{testimonial.text}</p>
          </div>
        ))}
      </div>
    </div>
